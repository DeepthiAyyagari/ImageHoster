...
public class ImageRepository {
    ...
    // Fetching image by its ID by changing the function to getImageObject()
    public Image getImageObject(Integer imageId, String title) {
        EntityManager em = emf.createEntityManager();
        try {
            TypedQuery<Image> typedQuery = em.createQuery("SELECT i from Image i where i.id =:id and i.title =:title", Image.class).setParameter("id", imageId).setParameter("title", title);
