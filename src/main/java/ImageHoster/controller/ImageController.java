...
public class ImageController {
    ...
    //Call the getImageObject() method in the business logic to fetch all the details of that image by its unique id
    ...
    //Editing this method to ensure that the user session is managed
    public String editImage(@RequestParam("imageId") Integer imageId, Model model, HttpSession session) {
        ...
        if (currentUser.getId() == imageOwner.getId()) {
            ...
            image.setaccessDeniedError("Only the owner of the image can edit the image");
            model.addAttribute("image", image);
            model.addAttribute("tags", tags);
            return "images/image";
        }
    ...
    public String editImageSubmit(@RequestParam("file") MultipartFile file, @RequestParam("imageId") Integer imageId, @RequestParam("tags") String tags, Image updatedImage, HttpSession session) throws IOException {
        ...
        // Fetching the image along with its Id
    ...
    public String deleteImageSubmit(@RequestParam(name = "imageId") Integer imageId, Model model, HttpSession session) {
        ...
        if (currentUser.getId() == imageOwner.getId()) {
            ...
            currentImage.setaccessDeniedError("Only the owner of the image can delete the image");
